...
- **Output languages: EN/JA/KR + ES/FR/DE/PT** (7). The four extra are Latin-script (no bundled fonts); their tab UI falls back to English and they auto-include in export when authored — the header keeps only EN/JA/KR export checkboxes to stay light.  
